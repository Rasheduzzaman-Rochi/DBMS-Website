...
<body>
  <div class=" bg-green-800 p-5">
    ...
    <div class="flex items-center justify-center space-x-2">
      <img src="./assets2/logo.svg" alt="logo" class="w-10 h-10">
      <span class="text-xl font-bold text-white"> শস্য শ্যামলা
      </span>
    </div>
  </div>
    <section class="relative h-[90vh] bg-cover bg-center flex items-center justify-center text-white op" style="background-image: url('./assets2/Image.png');">
