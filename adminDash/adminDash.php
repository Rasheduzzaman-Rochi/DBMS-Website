  ...
  <div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-green-900 text-white p-5">
      ...
      <nav class="space-y-4">
        ...
        <div id="inventory"
         class="hover:bg-green-800 rounded px-3 py-2 cursor-pointer">Inventory</div>
        <div id="storageMonitor"
         class="hover:bg-green-800 rounded px-3 py-2 cursor-pointer">Storage Monitor</div>
        <div id="salesDistribution" 
        class="hover:bg-green-800 rounded px-3 py-2 cursor-pointer">Sales & Distribution</div>
        <div id="lossRecords"
         class="hover:bg-green-800 rounded px-3 py-2 cursor-pointer">Loss Records</div>
        <div id="Alerts"
         class="hover:bg-green-800 rounded px-3 py-2 cursor-pointer">Alerts</div>
        <div id="Reports"
         class="hover:bg-green-800 rounded px-3 py-2 cursor-pointer">Reports & Improvement</div>
        <div id="farmer"
        class="mt-10 hover:bg-green-800 rounded px-3 py-2 cursor-pointer">Farmer</div>
        <div id="transport"
        class="mt-10 hover:bg-green-800 rounded px-3 py-2 cursor-pointer">Transporter</div>
        <div id="logout"
